...
type DropdownMenuSubTriggerRef = React.ElementRef<
  typeof DropdownMenuPrimitive.SubTrigger
>
type DropdownMenuSubTriggerNoRef = React.ComponentPropsWithoutRef<
  typeof DropdownMenuPrimitive.SubTrigger
>

const DropdownMenuSubTrigger = React.forwardRef<
  DropdownMenuSubTriggerRef,
  DropdownMenuSubTriggerNoRef & {
    inset?: boolean
  }
...
type DropdownMenuSubContentRef = React.ElementRef<
  typeof DropdownMenuPrimitive.SubContent
>
type DropdownMenuSubContentNoRef = React.ComponentPropsWithoutRef<
  typeof DropdownMenuPrimitive.SubContent
>

const DropdownMenuSubContent = React.forwardRef<
  DropdownMenuSubContentRef,
  DropdownMenuSubContentNoRef
>(({ className, ...props }, ref) => (
